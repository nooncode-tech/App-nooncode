...
| F-14 | High | docs | system-docs | `docs/context/project.context.full.md` carries a stale absolute repo path (`C:\Users\white\Documents\Codex\…`) and refers to past phase numbering. | Risk of confusion for new contributors and for AI agents loading deep context. | Docs cleanup pass after Phase 0 plan lands. |
